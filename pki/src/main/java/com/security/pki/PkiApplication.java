...
public class PkiApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User admin = new User(1, "123", passwordEncoder.encode("123"), adminRole, null, true, Timestamp.from(Instant.now()));
		userRepository.save(admin);

		User user = new User(2, "qwe", passwordEncoder.encode("123"), userRole, null, true, Timestamp.from(Instant.now()));
